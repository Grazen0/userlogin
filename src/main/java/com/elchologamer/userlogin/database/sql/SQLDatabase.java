...
public abstract class SQLDatabase extends Database {
    ...
    public SQLDatabase(String name, String driver) {
        this.name = name;
        this.driver = driver;

        ConfigurationSection section = getPlugin().getConfig().getConfigurationSection("database." + name);
    ...
    public void connect() throws SQLException, ClassNotFoundException {
        ...
        int maxChars = Math.max(getPlugin().getConfig().getInt("password.maxCharacters", 128), 1);
